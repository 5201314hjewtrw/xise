...
router.put('/:id', authenticateToken, async (req, res) => {
  try {
    ...
    const { nickname, avatar, background_image, bio, location, gender, zodiac_sign, mbti, education, major, interests } = req.body;
    ...
    const updatedUser = await prisma.user.findUnique({
      ...
      select: {
        id: true, user_id: true, nickname: true, avatar: true, background_image: true, bio: true, bio_audit_status: true,
